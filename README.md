...
# Quiz App with NestJS and In-Memory Database

This is a simple **Quiz App** built using **NestJS** and an **in-memory database**. The app allows you to create quizzes, add questions, answer questions, and calculate scores for users after they complete a quiz.
